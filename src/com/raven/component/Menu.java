...
public class Menu extends javax.swing.JPanel {
    ...
    public void initMenuItem() {
        ...
        addMenu(new ModelMenu(new ImageIcon(getClass().getResource("/com/raven/icon/2.png")), "Test Lab", "Vulcan Execution", "Local Execution", "Dummy Home"));
        addMenu(new ModelMenu(new ImageIcon(getClass().getResource("/com/raven/icon/3.png")), "Test Suite"));
        addMenu(new ModelMenu(new ImageIcon(getClass().getResource("/com/raven/icon/3.png")), "Test Results"));
    }
